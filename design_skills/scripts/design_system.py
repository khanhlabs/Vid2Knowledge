    ...
    def generate(self, query: str, project_name: str = None) -> dict:
        ...
        return {
            ...
            "colors": {
                ...
                "cta": best_color.get("Accent", "#EA580C"),
                "background": best_color.get("Background", "#F8FAFC"),
                "text": best_color.get("Foreground", "#1E293B"),
                "notes": best_color.get("Notes", "")
            },
            "typography": {
                "heading": best_typography.get("Heading Font", "Plus Jakarta Sans"),
...
def format_ascii_box(design_system: dict) -> str:
    ...
    checklist_items = [
        "[ ] No emojis as icons (use the chosen icon library)",
        "[ ] Interactive controls expose platform-appropriate affordance",
...
def format_markdown(design_system: dict) -> str:
    ...
    lines.append("- [ ] No emojis as icons (use the chosen icon library)")
    lines.append("- [ ] Interactive controls expose platform-appropriate affordance")
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("### Typography")
    lines.append("")
    lines.append(f"- **Heading Font:** {typography.get('heading', 'Plus Jakarta Sans')}")
    ...
    lines.append("- ❌ **Missing interaction affordance** — Interactive elements must look and behave as interactive")
    ...
    lines.append("")
    lines.append("- [ ] No emojis used as icons (use the chosen icon set instead)")
    lines.append("- [ ] All icons use one consistent icon set")
    lines.append("- [ ] Interactive controls expose platform-appropriate affordance")
    lines.append("- [ ] Press, hover, or focus states use smooth transitions (150-300ms)")
    lines.append("- [ ] Light mode: text contrast 4.5:1 minimum")
